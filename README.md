...
O saldo desbloqueado do FGTS 💵

A taxa de juros mensal (convertida automaticamente para diária) 📉

A taxa de IOF vigente (0,38% + 0,0082% ao dia)
...
✅ Máscara inteligente para o campo de data (DD/MM/AAAA) 📅
✅ Exibição dos resultados em formato de tabela detalhada (com saque, juros, saldo a antecipar e saldo a receber)
...
🧮 React Native Paper (para componentes de interface e tabela)
